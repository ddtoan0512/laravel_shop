...
<body>
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link {{ \Request::route()->getName() == 'admin.home' ? 'active' : '' }}"
                href="{{ route('admin.home') }}" href="#">
                <span data-feather="home"></span>
                Trang tổng quan <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ \Request::route()->getName() == 'admin.get.list.category' ? 'active' : '' }}"
            ...
            <li class="nav-item ">
              <a class="nav-link {{ \Request::route()->getName() == 'admin.get.list.product' ? 'active' : '' }}"
            ...
            <li class="nav-item">
              <a class="nav-link {{ \Request::route()->getName() == 'admin.get.list.article' ? 'active' : ''}} "
  ...
  <script>
    window.jQuery || document.write('<script src="{{asset('theme_admin/js/jquery.slim.min.js')}}"><\/script>')
  </script>
  <script src="{{asset('theme_admin/js/bootstrap.bundle.min.js')}}"
