<form action="" method="POST">
  ...
  <div class="form-group">
      ...
      <textarea name="a_description" class="form-control" placeholder="Mô tả bài viết" cols="30" rows="3">{{ old('a_description', isset($article->a_description) ? $article->a_description : '') }}      </textarea>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea name="a_content" class="form-control" placeholder="Nội dung bài viết" cols="30" rows="3">{{ old('a_description', isset($article->a_content) ? $article->a_content : '') }}</textarea>
  </div>
  ...
  <div class="form-group">
    <label for="a_avatar" class="h5">Avatar</label>
