<!DOCTYPE html>
<!-- saved from url=(0030)https://www.thegioididong.com/ -->
<html lang="vi">
...
<head>
    ...
    <title>Thế giới di động - Siêu thị điện thoại, Tablet, Laptop, Phụ kiện chính hãng</title>
    ...
    <link href="https://www.thegioididong.com/favicon.ico" rel="shortcut icon" type="image/x-icon">
    <link href="https://www.thegioididong.com/favicon.ico" rel="apple-touch-icon">
    <link href="https://www.thegioididong.com/favicon.ico" rel="apple-touch-icon-precomposed">
    ...
    <style>
        ...
        * {
        ...
        .homeproduct li:nth-child(4),
        .homeproduct li:nth-child(8) {
        ...
        .pop-overload .ov-address .ov-wrapsuggest:before,
    ...
    <script async=""
        src="./Thegioididong.com - Siêu thị điện thoại, Tablet, Laptop, Phụ kiện chính hãng_files/gtm.js.tải xuống">
    </script>
    <script src="./Thegioididong.com - Siêu thị điện thoại, Tablet, Laptop, Phụ kiện chính hãng_files/3880.js.tải xuống"
        async="" type="text/javascript"></script>
    <script async=""
        src="./Thegioididong.com - Siêu thị điện thoại, Tablet, Laptop, Phụ kiện chính hãng_files/hotjar-34921.js.tải xuống">
    </script>
    <link rel="stylesheet" type="text/css" href="https://cdn.thegioididong.com/dmxchat/chatcore2017.v201901000046.d">
</head>
...
<body class="" style="">
    ...
    <script>
        (function (f, b) {
            ...
            f._hjSettings = { hjid: 34921, hjsv: 6 };
    ...
    <div id="notifychatmsg" class="chattgdd" style="bottom: 100px; top: auto; right: 2px; left: auto;"> </div>
    <div id="notifychatmsgmin"> </div>
    <div id="notifychatnewmsg" style="position: fixed; top: 200px; left: 951.5px;"> </div>
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header"><button type="button" class="close" data-dismiss="modal"
                        aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title" id="myModalLabel">Bình luận của bạn đã được trả lời</h4>
                </div>
                <div class="modal-body" id="chat-invite-body">{%content%}</div>
                <div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Đóng
                        lại</button><button type="button" class="btn btn-primary" id="review_answer">Xem lại trả
                        lời</button><button type="button" class="btn btn-primary" data-dismiss="modal"
                        onclick="acceptChat()" id="chat_with_admin">Chat ngay với QTV</button></div>
            </div>
        </div>
    </div>
    <div style="clear:both;"></div>
    <div id="chatclient-back"></div>
    <div id="chatclient">
        <div class="navbar navbar-inverse navbar-fixed-bottom chattgdd" style="bottom: 2px; top: auto;">
            <div id="divmsg"></div>
            <ul class="pages" style="height: 500px;">
                <li class="pagechat chat page" style="height: 500px;">
                    <div class="operator-info"></div>
                    <div class="chatArea" style="height: 387px;">
                        <div id="chatrating">Cảm ơn bạn đã sử dụng dịch vụ của TGDD.<br> </div>
                        <ul class="messages" style="height: 387px;"></ul>
                    </div>
                    <div class="chatwait" id="chatwait" style=" height 22px; "></div>
                    <div class="chatinputarea">
                        <form onsubmit="return false;">
                            <table style="width:100%;padding:0px;margin:0px">
                                <tbody>
                                    <tr>
                                        <td style="width: 42px; "> <input id="upload-image" type="file" multiple=""
                                                class="upload-image" itemid="0"
                                                title="Chèn ảnh kích thước tối đa 1MB/hình" name="file"><img
                                                id="insertimage" class="chatfunctions-insertimg"
                                                src="https://cdn.thegioididong.com/dmxchat/chenhinh_tgdd.v201901000046.png">
                                        </td>
                                        <td> <textarea class="chatinput fe"
                                                placeholder="Kết nối bị gián đoạn, vui lòng đợi trong giây lát hoặc tải lại trang"
                                                disabled="disabled"></textarea> </td>
                                        <td style="width: 50px; "><button id="sendchat"
                                                class="chatfunctions-sendchat">Gửi</button> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </form>
                ...
                <li class="pagecollect page" style="height: 500px;">
                    <div class="operator-info"></div>
                    <form onsubmit="return false;">
                        <div id="collectdata" style="height: 500px;"></div>
                    </form>
                </li>
                <li class="pageclose  page" style="height: 500px;">
                    <div class="operator-info"></div>
                    <form onsubmit="return false;">
                        <div id="chatcloseconfirm"> xxx</div>
                    </form>
                </li>
            </ul>
        </div>
        <div id="chattooltipmsg" class="minimize" onclick="maximizeChatWindow()"
            style="bottom: 100px; top: auto; right: 2px; left: auto;">
            <div style="position: relative;">
                <div class="msgalert">!</div>
                <div style="z-index: -1;top: 2px;width: 216px;right:60px;height: 45px;display: none;" id="tooltip349481"
                    class="tooltip fade left in" role="tooltip">
                    <div class="tooltip-inner"></div>
                </div>
                <div class="operator-info-min"></div>
            </div>
        </div>
    </div>
    <div id="chatclient-backfull"></div>
    <div id="chatclientcmt">
        <div class="navbar navbar-inverse navbar-fixed-bottom chattgdd "
            style="height: 500px; bottom: auto; top: 20px; right: auto; left: 601.5px;">
            <div id="divmsg"></div>
            <ul class="pages" style="height: 500px;">
                <li class="pagechat chat page" style="height: 500px;">
                    <div class="operator-info">
                        <ul>
                            <li>Chào Bạn<span class="namecmt"></span>. Chúc Bạn một ngày tốt lành! </li>
                            <li class="last"> <a class="stopchat" title="Đóng" href="javascript:void(0)"
                                    onclick="closeAndStopChatCMT()"><img class="closeAndStopChatimg"
                                        src="https://cdn.thegioididong.com/dmxchat/iconstopcmt_1.v201901000046.png"></a>
                            </li>
                        </ul>
                    </div>
                    <div class="chatArea" style="height: 387px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td> <textarea class="chatinput fe"
                                                placeholder="Kết nối bị gián đoạn, vui lòng đợi trong giây lát hoặc tải lại trang"
                                                disabled="disabled"></textarea> </td>
                                        <td style="width: 50px; "> <button id="sendchatcmt"
                                                class="chatfunctions-sendchat">Gửi</button> </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <li class="pageclose chat page" style="height: 500px;">
                    <div class="operator-info">
                        <ul>
                            <li>Chào Bạn<span class="namecmt"></span>. Chúc Bạn một ngày tốt lành! </li>
                            <li class="last"> <a class="stopchat" title="Đóng" href="javascript:void(0)"
                    ...
                    <form onsubmit="return false;">
                        <div id="chatcloseconfirm" style="height: 500px;"> xxx</div>
                    </form>
                </li>
            </ul>
        </div>
