        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              Giỏ hàng <div class="pull-right"><small><a class="afix-1" href="{{ route('get.list.shopping.cart') }}">Cập
                    nhật giỏ hàng</a></small></div>
            </div>
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6 col-xs-6">
                  ...
                  <div class="col-xs-12"><small>{{ $product->qty }}</small></div>
                </div>
              ...
              <div class="form-group">
                <div class="col-xs-12">
                  ...
                  <div class="pull-right">{{ Cart::subtotal() }}<span>vnđ</span><span></span></div>
                </div>
              </div>
            </div>
          </div>
